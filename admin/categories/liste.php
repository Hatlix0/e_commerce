  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <textarea name="description" class="form-control" placeholder="Descirption de categories..."></textarea>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="nom" required class="form-control" value="<?php echo $categorie['nom']; ?>" placeholder="Nom de categories ...">

        </div>
        <div class="form-group">

        <textarea name="description" required class="form-control" placeholder="Descirption de categories..."> <?php echo $categorie['description']; ?> </textarea>
